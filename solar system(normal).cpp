# include <iostream>
 ...
 initwindow(5000,5000);
    ...
    if(error_code!=grOk)
    {
       ...
       //textmode(BW80);
       system("CLS");
       std::cout<<"\n Fatal Error  : Graphic Driver not initialized"<<std::endl;
        std::cout<<" Error Reason : "<<grapherrormsg(error_code)<< std::endl;
    ...
    for(int count=0;count<5000;count++)
       putpixel(rand(),rand(),rand());//640 480 15
